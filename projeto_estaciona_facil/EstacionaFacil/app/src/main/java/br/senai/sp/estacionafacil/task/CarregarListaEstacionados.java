...
public class CarregarListaEstacionados extends AsyncTask {
    ...
    public CarregarListaEstacionados(Context context){
    ...
    protected Object doInBackground(Object[] objects) {
        try {
            URL url = new URL("http://"+ Ip.getIp() +":8080/veiculo/estacionados");
    ...
    protected void onPostExecute(Object o) {
        ...
        Estacionados.listaEstacionados.setAdapter(adapter);
